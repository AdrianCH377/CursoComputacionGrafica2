...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Materiales e Iluminacion- CRUZ HERNANDEZ SANTIAGO ADRIAN", nullptr, nullptr);
    ...
    image = stbi_load("Models/texture.jpg", &textureWidth, &textureHeight, &nrChannels, 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shiniess"), 0.6f);
